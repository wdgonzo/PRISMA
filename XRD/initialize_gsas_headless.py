...
def initialize_gsas_scriptable(gsasii_dir):
    ...
    try:
        ...
        # Attempt to install G2script shortcut (optional - official method from docs)
        print("Attempting to install G2script shortcut...")
        print("  (This is optional - only needed if ~/.GSASII/config.ini exists)")
        try:
            G2sc.installScriptingShortcut()
            print("  ✓ G2script shortcut installed!")
            print()
            print("✓ GSAS-II setup complete (using G2script shortcut)")
            print()
            print("Your code will use: import G2script")
        except Exception as e:
            print(f"  ℹ Shortcut installation skipped: {e}")
            print()
            print("  This is normal on HPC systems without ~/.GSASII/config.ini")
            print()
            print("✓ GSAS-II setup complete (using direct import)")
            print()
            print("Your code will automatically use:")
            print("  from GSASII import GSASIIscriptable as G2script")
            print()
            print("The fallback is built into your code - no action needed!")
        print()
